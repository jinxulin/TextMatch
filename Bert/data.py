...
class DataPrecessForSentence(Dataset):
    ...
    def __init__(self, bert_tokenizer, LCQMC_file, max_char_len=103):
        ...
        self.seqs, self.seq_masks, self.seq_segments, self.labels = self.get_input(
            LCQMC_file)
    ...
    def get_input(self, file):
        ...
        tokens_cate_1 = list(map(self.bert_tokenizer.tokenize, cate_1))
        tokens_cate_2 = list(map(self.bert_tokenizer.tokenize, cate_2))
        # 获取定长序列及其mask
        result = list(map(self.trunate_and_pad, tokens_seq_1,
                          tokens_seq_2, tokens_cate_1, tokens_cate_2))
    ...
    def trunate_and_pad(self, tokens_seq_1, tokens_seq_2, tokens_cate_1, tokens_cate_2):
        """
